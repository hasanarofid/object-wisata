          ...
          <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
            <div class="card-header flex-column flex-md-row">
              <div class="head-label text-center">
                <h5 class="card-title mb-0">Data User Admin</h5>
              </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Action Buttons"  @if($item->id == 1) style="display: none;" @endif >
                                ...
                                <a href="{{ route('user.edit', $item->id) }}" class="btn btn-sm btn-warning" role="button">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                        
                                <form method="POST" action="{{ route('user.destroy', $item->id) }}" onsubmit="return confirm('Are you sure you want to delete this item?')">
                                    @csrf
                                    @method('DELETE')
