            ...
            <div class="card-header flex-column flex-md-row">
              ...
              <div class="dt-action-buttons text-end pt-3 pt-md-0">
                <div class="dt-buttons btn-group flex-wrap">
                    ...
                    <a href="{{ route('kriteria.create') }}" class="btn btn-sm btn-primary" role="button">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Action Buttons">
                                ...
                                <a href="{{ route('kriteria.edit', $item->id) }}" class="btn btn-sm btn-warning" role="button">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                        
                                <form method="POST" action="{{ route('kriteria.destroy', $item->id) }}" onsubmit="return confirm('Are you sure you want to delete this item?')">
                                    @csrf
                                    @method('DELETE')
